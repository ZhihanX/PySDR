...
class Constant_pilot(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Constant pilot22", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Constant pilot22")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Constant_pilot")
        ...
        self.analog_sig_source_x_0_1 = analog.sig_source_c(samp_rate, analog.GR_CONST_WAVE, 100000, 1000, 0, 0)
...
def main(top_block_cls=Constant_pilot, options=None):
